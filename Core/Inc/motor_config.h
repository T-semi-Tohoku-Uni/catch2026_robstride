...
#define ROBSTRIDE_INIT_TIMEOUT_MS 15000U
#define ROBSTRIDE_INIT_PROBE_INTERVAL_MS 50U
#define ROBSTRIDE_INIT_RETRY_INTERVAL_MS 300U
#define ROBSTRIDE_FEEDBACK_TIMEOUT_MS 100U
